...
public:
    ...
    void setParameterByIndex(int index, double value) {
        switch (index) {
            case 0: A = pinParameter(static_cast<float>(value)); break;
            case 1: B = pinParameter(static_cast<float>(value)); break;
            case 2: C = pinParameter(static_cast<float>(value)); break;
            case 3: D = pinParameter(static_cast<float>(value)); break;
            case 4: E = pinParameter(static_cast<float>(value)); break;
            default: break;
        }
    }
